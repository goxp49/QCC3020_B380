...
extern void appScoFwdUserPowerOff(void);
...
extern void appHfpSetMediaStarConfirmFlag(void);
extern void appHfpClearMediaStarConfirmFlag(void);
extern void appScoFwdHandleStartReceiveChain(void);
extern void appScoFwdHandleStopReceiveChain(void);
#endif
...
enum av_headset_scofwd_ota_messages
{
	...
	/*! Notify the earbud to power off */
