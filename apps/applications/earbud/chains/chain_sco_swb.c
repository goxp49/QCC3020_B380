/*!
    ...
    \brief The chain_sco_swb chain. This file is generated by C:/qtil/ADK_QCC512X_QCC302X_WIN_6.4.0.41/tools/chaingen/chaingen.py.
*/
...
{
    MAKE_OPERATOR_CONFIG_PRIORITY_MEDIUM(CAP_ID_SWBS_DEC, OPR_SCO_RECEIVE),
    MAKE_OPERATOR_CONFIG_PRIORITY_HIGH(CAP_ID_SWBS_ENC, OPR_SCO_SEND),
...
const chain_config_t chain_sco_swb_config = {1, 0, operators, 7, inputs, 3, outputs, 2, connections, 7};
