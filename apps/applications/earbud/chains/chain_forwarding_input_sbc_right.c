/*!
    ...
    \version 
    \file chain_forwarding_input_sbc_right.c
    \brief The chain_forwarding_input_sbc_right chain. This file is generated by C:/qtil/ADK_QCC512X_QCC302X_WIN_6.4.0.41/tools/chaingen/chaingen.py.
*/

#include <chain_forwarding_input_sbc_right.h>
...
static const operator_endpoint_t outputs[] =
{
    ...
    {OPR_SBC_DECODER, EPR_SOURCE_DECODED_PCM, 1}
};

static const operator_connection_t connections[] =
{
    {OPR_RTP_DECODER, 0, OPR_SBC_DECODER, 0, 1},
    {OPR_SBC_DECODER, 0, OPR_SBC_ENCODER, 0, 1},
    {OPR_SBC_ENCODER, 0, OPR_SWITCHED_PASSTHROUGH_CONSUMER, 0, 1}
};

const chain_config_t chain_forwarding_input_sbc_right_config = {0, 0, operators, 4, inputs, 1, outputs, 2, connections, 3};
