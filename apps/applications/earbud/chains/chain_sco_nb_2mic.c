/*!
    ...
    \version 
    \file chain_sco_nb_2mic.c
    \brief The chain_sco_nb_2mic chain. This file is generated by C:/qtil/ADK_QCC512X_QCC302X_WIN_6.4.0.41/tools/chaingen/chaingen.py.
*/
...
const chain_config_t chain_sco_nb_2mic_config = {0, 0, operators, 7, inputs, 4, outputs, 2, connections, 8};
