/*!
    ...
    \version 
    \file chain_forwarding_input_aac_left.c
...
#include <chain_forwarding_input_aac_left.h>
...
static const operator_connection_t connections[] =
{
    ...
    {OPR_AAC_DECODER, 1, OPR_SBC_ENCODER, 0, 1},
    {OPR_SBC_ENCODER, 0, OPR_SWITCHED_PASSTHROUGH_CONSUMER, 0, 1}
};

const chain_config_t chain_forwarding_input_aac_left_config = {0, 0, operators, 4, inputs, 1, outputs, 2, connections, 3};
