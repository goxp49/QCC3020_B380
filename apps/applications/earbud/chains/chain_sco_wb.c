/*!
    ...
    \version 
    \file chain_sco_wb.c
    \brief The chain_sco_wb chain. This file is generated by C:/qtil/ADK_QCC512X_QCC302X_WIN_6.4.0.41/tools/chaingen/chaingen.py.
*/
...
const chain_config_t chain_sco_wb_config = {1, 0, operators, 7, inputs, 3, outputs, 2, connections, 7};
