/*!
    ...
    \version 
    \file chain_micfwd_send_2mic.c
    \brief The chain_micfwd_send_2mic chain. This file is generated by C:/qtil/ADK_QCC512X_QCC302X_WIN_6.4.0.41/tools/chaingen/chaingen.py.
*/

#include <chain_micfwd_send_2mic.h>
...
static const operator_config_t operators[] =
{
    ...
    MAKE_OPERATOR_CONFIG(EB_CAP_ID_ASYNC_WBS_ENC, OPR_MICFWD_SEND),
...
const chain_config_t chain_micfwd_send_2mic_config = {1, 0, operators, 7, inputs, 4, outputs, 2, connections, 8};
