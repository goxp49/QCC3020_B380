/*!
    ...
    \version 
    \file chain_micfwd_wb_2mic.c
    \brief The chain_micfwd_wb_2mic chain. This file is generated by C:/qtil/ADK_QCC512X_QCC302X_WIN_6.4.0.41/tools/chaingen/chaingen.py.
*/

#include <chain_micfwd_wb_2mic.h>
...
static const operator_connection_t connections[] =
{
    ...
    {OPR_MICFWD_RECV, 0, OPR_MICFWD_SPC_SWITCH, 1, 1},
    {OPR_MICFWD_SPC_SWITCH, 0, OPR_SCO_SEND, 0, 1}
};

const chain_config_t chain_micfwd_wb_2mic_config = {1, 0, operators, 14, inputs, 5, outputs, 3, connections, 15};
