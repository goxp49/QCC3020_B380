/*!
    ...
    \version 
    \file chain_scofwd_nb.c
    \brief The chain_scofwd_nb chain. This file is generated by C:/qtil/ADK_QCC512X_QCC302X_WIN_6.4.0.41/tools/chaingen/chaingen.py.
*/

#include <chain_scofwd_nb.h>
...
const chain_config_t chain_scofwd_nb_config = {1, 0, operators, 11, inputs, 3, outputs, 3, connections, 11};
