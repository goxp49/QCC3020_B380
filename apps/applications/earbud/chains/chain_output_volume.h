/*!
    ...
    \brief The chain_output_volume chain. This file is generated by C:/qtil/ADK_QCC512X_QCC302X_WIN_6.4.0.41/tools/chaingen/chaingen.py.
*/
...
/*!
    @startuml
        ...
        object OPR_PEQ
        OPR_PEQ : id = CAP_ID_PEQ
        OPR_SOURCE_SYNC "IN(0)"<-- "OUT(0)" OPR_LATENCY_BUFFER
        OPR_PEQ "IN(0)"<-- "OUT(0)" OPR_SOURCE_SYNC
        OPR_VOLUME_CONTROL "MAIN_IN(0)"<-- "OUT(0)" OPR_PEQ
