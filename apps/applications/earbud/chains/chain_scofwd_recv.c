/*!
    ...
    \brief The chain_scofwd_recv chain. This file is generated by C:/qtil/ADK_QCC512X_QCC302X_WIN_6.4.0.41/tools/chaingen/chaingen.py.
*/
...
const chain_config_t chain_scofwd_recv_config = {1, 0, operators, 4, inputs, 3, outputs, 1, connections, 3};
