/*!
    ...
    \version 
    \file chain_micfwd_wb.c
    \brief The chain_micfwd_wb chain. This file is generated by C:/qtil/ADK_QCC512X_QCC302X_WIN_6.4.0.41/tools/chaingen/chaingen.py.
*/

#include <chain_micfwd_wb.h>
...
const chain_config_t chain_micfwd_wb_config = {1, 0, operators, 14, inputs, 4, outputs, 3, connections, 14};
