...
#ifndef _CHAIN_MICFWD_NB_2MIC_H__
#define _CHAIN_MICFWD_NB_2MIC_H__
...
extern const chain_config_t chain_micfwd_nb_2mic_config;

#endif /* _CHAIN_MICFWD_NB_2MIC_H__ */
