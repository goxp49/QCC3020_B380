...
#ifdef LINK_LOSS
DEFINE_RULE(ruleLinkLossReconnectHandset);
#endif
...
ruleEntry appConnRules[] =
{
    ...
    /*! \} */
#ifdef LINK_LOSS
	RULE(RULE_EVENT_HANDSET_LINK_LOSS,			ruleLinkLossReconnectHandset,	CONN_RULES_RECONNECT_HANDSET),
#endif
...
#ifdef LINK_LOSS
static ruleAction ruleLinkLossReconnectHandset(void)
{
    RULE_LOG("ruleLinkLossReconnectHandset");
                                     ...
                                     rulePostHandsetConnectAction post_connect_action)
{
	...
	{
	    RULE_LOG("ruleConnectHandset, ignore 1");
		return RULE_ACTION_IGNORE;
	}
    
    if(!appUserGetPowerOffEnable())
	{
	    RULE_LOG("ruleConnectHandset, ignore 2");
		return RULE_ACTION_IGNORE;
	}
#endif
...
#ifdef SINGLE_BDADDR
	if(appUserIsPageScanDisable() || appChargerIsConnected())
	{
		 return RULE_ACTION_IGNORE;
	}
#endif
